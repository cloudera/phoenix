...
@RunWith(Parameterized.class) @Category(NeedsOwnMiniClusterTest.class)
public class MutableIndexExtendedIT extends ParallelStatsDisabledIT {
    ...
    @Test public void testCompactDisabledIndex() throws Exception {
    ...
    @Test(timeout = 120000) public void testCompactNonPhoenixTable() throws Exception {
        try (Connection conn = getConnection()) {
    ...
    @Test public void testIndexHalfStoreFileReader() throws Exception {
