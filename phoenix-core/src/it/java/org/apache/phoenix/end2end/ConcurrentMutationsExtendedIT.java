...
public class ConcurrentMutationsExtendedIT extends ParallelStatsDisabledIT {
    ...
    @Test public void testSynchronousDeletesAndUpsertValues() throws Exception {
    ...
    @Test public void testConcurrentDeletesAndUpsertValues() throws Exception {
        final String tableName = generateUniqueName();
        final String indexName = generateUniqueName();
        Connection conn = DriverManager.getConnection(getUrl());
        conn.createStatement().execute("CREATE TABLE " + tableName
    ...
    @Test @Repeat(5) public void testConcurrentUpserts() throws Exception {
        int nThreads = 4;
    ...
    @Test public void testRowLockDuringPreBatchMutateWhenIndexed() throws Exception {
    ...
    @Test public void testLockUntilMVCCAdvanced() throws Exception {
